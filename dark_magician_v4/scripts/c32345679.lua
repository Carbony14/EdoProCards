...
local s,id=GetID()
s.listed_names={CARD_DARK_MAGICIAN, 30208479, 59514116}
...
function s.initial_effect(c)
    ...
    -- Add "Secrets of Dark Magic" if sent to GY or banished
    ...
    -- Allow Quick-Play Spells from hand during opponent's turn
...
function s.thfilter(c)
	return c:IsCode(59514116) and c:IsAbleToHand()
end
